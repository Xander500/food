            ...
            <form class="log_filters" action="viewAllLogs.php?" method="GET">
                ...
                <div class="log_filters--row">
                    <div class="log_filter">
                        <label for="studentSelect">Search by Students</label>
                    ...
                    <div class="log_filter">
                        <label for="organizationSelect">Search by Organizations</label>
                    ...
                    <div class="log_filter">
                        <label for="semesterSelect">Search by Semesters</label>
