...
<body>
    <div class="graphs-wrapper">
        <div class="graph-card">
            <h2>Volunteer Hours by Month <?php echo date('Y'); ?></h2>
            <canvas id="hoursChart"></canvas>
        </div>

        <div class="graph-card">
            <h2>Pounds of Food Rescued by Month <?php echo date('Y'); ?></h2>
            <canvas id="poundsChart"></canvas>
        </div>
    </div>
    <script>
    const months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
    const hoursData = build_month_array(<?php echo json_encode(get_monthly_hours()); ?>);
    const poundsData = build_month_array(<?php echo json_encode(get_monthly_pounds()); ?>);
