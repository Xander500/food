...
<body>
    ...
    <main class="event-info">
        ...
        <a class="button cancel" href="addLog.php" style="margin-left: auto; margin-right: auto; width: 40%;">Add Volunteer Actitvity</a>
        <a class="button cancel" href="index.php" style="margin-left: auto; margin-right: auto; width: 40%;">Return to Dashboard</a>
